...
Consumer-facing APIs are documented using [JSDoc](https://jsdoc.app/) comments in the source code @ [/src](https://github.com/kysely-org/kysely-aws/tree/main/src).
...
- Everything is tested.
  - Functionality - No mocks. Everything is tested against real AWS services.
    No partial testing.
